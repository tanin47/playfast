...
import mockws.{FakeAhcResponse, RouteNotDefined, SchedulerExecutorServiceTimeoutProvider, TimeoutProvider}
import org.apache.pekko.stream.Materializer
import org.apache.pekko.stream.scaladsl.Source
import org.apache.pekko.util.ByteString
import org.slf4j.LoggerFactory
import play.api.libs.ws.*
import play.api.libs.ws.ahc.{AhcWSRequest, AhcWSResponse, StandaloneAhcWSClient, StandaloneAhcWSRequest}
...
// The class is copied from mockws.FakeWSRequestHolder.
// Because we need both a mock request and a real request.
// With our new class, we are able to achieve that.
case class FakeWSRequestHolder(
  routes: Routes,
  realWSClient: StandaloneAhcWSClient,
  url: String,
  method: String = "GET",
